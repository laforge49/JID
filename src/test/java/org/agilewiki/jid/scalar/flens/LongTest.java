...
public class LongTest extends TestCase {
    public void test() {
        ...
        try {
            ...
            LongJidC.setValueReq(1L).send(future, long2);
            ...
            long v = LongJidC.getValueReq.send(future, long1);
            assertEquals(0L, v);
            v = LongJidC.getValueReq.send(future, long2);
            assertEquals(1L, v);
            v = LongJidC.getValueReq.send(future, float3);
            assertEquals(1L, v);
            ...
            v = LongJidC.getValueReq.send(future, rpa);
            assertEquals(0L, v);
            LongJidC.setValueReq(-1000000000000L).send(future, rpa);
