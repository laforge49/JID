...
public class DoubleJid
     ...
     */
    public static final MakeValue makeValueReq(Double value) {
    ...
    protected void setValue(Internals internals, SetValue request) throws Exception {
        double v = (Double) request.getValue();
        if (value == v)
            return;
        value = v;
        serializedData = null;
     ...
     */
    @Override
    protected Double getValue(Internals internals) throws Exception {
        return getValue();
    }
     ...
     */
    @Override
    public int compareTo(DoubleJid o) {
