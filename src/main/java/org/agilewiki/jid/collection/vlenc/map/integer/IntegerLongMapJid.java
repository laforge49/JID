...
/**
 * Holds a map with Integer keys and LongJid values.
 */
final public class IntegerLongMapJid extends IntegerMapJid {
    /**
     * Create a IntegerLongMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerLongMapJid(Mailbox mailbox) {
        super(mailbox);
    }
