...
/**
 * Holds a map with Integer keys and DoubleJid values.
 */
final public class IntegerDoubleMapJid extends IntegerMapJid {
    /**
     * Create a IntegerDoubleMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerDoubleMapJid(Mailbox mailbox) {
        super(mailbox);
    }
