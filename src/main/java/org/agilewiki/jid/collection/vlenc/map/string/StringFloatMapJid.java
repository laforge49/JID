...
/**
 * Holds a map with String keys and FloatJid values.
 */
final public class StringFloatMapJid extends StringMapJid {
    /**
     * Create a StringFloatMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public StringFloatMapJid(Mailbox mailbox) {
        super(mailbox);
    }
