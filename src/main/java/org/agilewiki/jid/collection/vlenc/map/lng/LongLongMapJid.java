...
/**
 * Holds a map with Long keys and LongJid values.
 */
final public class LongLongMapJid extends LongMapJid {
    /**
     * Create a LongLongMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public LongLongMapJid(Mailbox mailbox) {
        super(mailbox);
    }
