...
/**
 * Holds a map with Integer keys and IntegerJid values.
 */
final public class IntegerIntegerMapJid extends IntegerMapJid {
    /**
     * Create a IntegerIntegerMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerIntegerMapJid(Mailbox mailbox) {
        super(mailbox);
    }
