...
/**
 * Holds a map with Integer keys and ActorJid values.
 */
final public class IntegerActorMapJid extends IntegerMapJid {
    /**
     * Create a IntegerActorMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerActorMapJid(Mailbox mailbox) {
        super(mailbox);
    }
