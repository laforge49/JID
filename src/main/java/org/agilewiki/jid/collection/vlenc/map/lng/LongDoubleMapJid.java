...
/**
 * Holds a map with Long keys and DoubleJid values.
 */
final public class LongDoubleMapJid extends LongMapJid {
    /**
     * Create a LongDoubleMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public LongDoubleMapJid(Mailbox mailbox) {
        super(mailbox);
    }
