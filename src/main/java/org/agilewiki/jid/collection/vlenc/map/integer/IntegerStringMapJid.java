...
/**
 * Holds a map with Integer keys and StringJid values.
 */
final public class IntegerStringMapJid extends IntegerMapJid {
    /**
     * Create a LongStringMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerStringMapJid(Mailbox mailbox) {
        super(mailbox);
    }
