...
/**
 * Holds a map with Long keys and BytesJid values.
 */
final public class LongBytesMapJid extends LongMapJid {
    /**
     * Create a LongBytesMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public LongBytesMapJid(Mailbox mailbox) {
        super(mailbox);
    }
