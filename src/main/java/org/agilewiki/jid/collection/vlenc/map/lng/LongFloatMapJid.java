...
/**
 * Holds a map with Long keys and FloatJid values.
 */
final public class LongFloatMapJid extends LongMapJid {
    /**
     * Create a LongFloatMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public LongFloatMapJid(Mailbox mailbox) {
        super(mailbox);
    }
