 ...
 */
public class GetCeiling<KEY_TYPE extends Comparable> extends SynchronousRequest<Actor, Map<KEY_TYPE>> {
    /**
     * The key.
     */
     ...
     * @param key The key.
     */
    public GetCeiling(KEY_TYPE key) {
        this.key = key;
    }
