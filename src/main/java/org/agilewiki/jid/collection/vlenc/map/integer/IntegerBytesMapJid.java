...
/**
 * Holds a map with Integer keys and BytesJid values.
 */
final public class IntegerBytesMapJid extends IntegerMapJid {
    /**
     * Create a IntegerBytesMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerBytesMapJid(Mailbox mailbox) {
        super(mailbox);
    }
