...
/**
 * Holds a map with String keys and LongJid values.
 */
final public class StringLongMapJid extends StringMapJid {
    /**
     * Create a StringLongMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public StringLongMapJid(Mailbox mailbox) {
        super(mailbox);
    }
