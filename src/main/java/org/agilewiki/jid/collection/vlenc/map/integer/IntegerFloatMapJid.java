...
/**
 * Holds a map with Integer keys and FloatJid values.
 */
final public class IntegerFloatMapJid extends IntegerMapJid {
    /**
     * Create a IntegerFloatMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public IntegerFloatMapJid(Mailbox mailbox) {
        super(mailbox);
    }
