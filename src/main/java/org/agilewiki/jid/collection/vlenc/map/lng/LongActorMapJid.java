...
/**
 * Holds a map with Long keys and ActorJid values.
 */
final public class LongActorMapJid extends LongMapJid {
    /**
     * Create a LongActorMapJid
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public LongActorMapJid(Mailbox mailbox) {
        super(mailbox);
    }
