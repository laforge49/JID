...
/**
 * Defines collection of doubles.
 */
public class DoubleActorsType extends ActorsType {

    private _JidFactory jidFactory;

    /**
     * Create a DoubleActorsType
     *
     * @param mailbox A mailbox which may be shared with other actors.
     */
    public DoubleActorsType(Mailbox mailbox) {
        super(mailbox);
    }
    ...
    public _JidFactory getValueFactory()
            throws Exception {
        if (jidFactory == null)
            jidFactory = new DoubleJidFactory();
        return jidFactory;
    }
}
